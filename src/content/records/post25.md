...
galleryFolder: '""'
---
서울에서는 세계 불꽃축제가 있었다지. 그날, 미리 신청해둔 행사가 있어 우리는 구례로 향했다. 티하우스 일지와 FC호흡으로 모인 작가들이 함께 진행한 천은사 템플스테이. 팔로우하고 있던 작가님 스토리를 통해 알게 된 행사다. 아홉명의 작가들 작품을 감상하는 데 그치지 않고, 차회를 통해 사용해보고 이야기를 나눌 수 있는 행사라는 점에서 독특한 기획이었다.
